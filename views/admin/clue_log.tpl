...
<div class="content-control">
    <a class="back" href="/admin/clue">返回线索列表 >></a>
</div>
<div class="content-mainer">
    {% if userInfo.role == 1 %}
    <div class="form-section clue-form">
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="form-item">
                <select id="clueStatus" class="form-input">
                    ...
                    <option value="1" {% if clue.status==1 %} seleted {% endif %}>没有意向</option>
                    <option value="2" {% if clue.status==2 %} seleted {% endif %}>意向一般</option>
                    <option value="3" {% if clue.status==3 %} seleted {% endif %}>意向强烈</option>
                    <option value="4" {% if clue.status==4 %} seleted {% endif %}>完成销售</option>
                    <option value="5" {% if clue.status==5 %} seleted {% endif %}>取消销售</option>
                </select>
            </div>
        </div>
        <div class="form-item">
    ...
    <div class="log-section">
        <ul class="log-list">
            {% for val in logs %}
            <li class="log-item">
                <p class="log-date">{{val.created_time_display}}</p>
